function [yfit] = model_elasticnet_dt_ensemble(x_train, y_train, x_test)
    ...
    for i = 1:7
        ...
        tree_fit{i} = TreeBagger(1, full(X{i}), residuals{i}, 'method', 'regression', 'Options', tree_stats,'MinLeaf', 2);
