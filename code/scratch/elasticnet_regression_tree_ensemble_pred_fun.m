function [yfit] = elasticnet_regression_tree_ensemble_pred_fun(x_train, y_train, x_test)
...
for i = 1:7
    ...
    t = RegressionTree.template('MinLeaf',3);
    tree_fit{i} = fitensemble(full(X{i}), residuals{i}, 'LSBoost', 35, t)
...
save('slow_reg_tree.mat', 'tree_fit');
save('slow_cvglmnet.mat', 'cvglmnet_fit');
